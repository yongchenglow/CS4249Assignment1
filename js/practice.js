...
function nextTrial() {
	...
	if (currentTrial <= numTrials) {
		...
		var pointingDevice = trialsData[currentTrial]['Pointing Device'];
		...
		document.getElementById("pointingDevice").innerHTML = pointingDevice;
		...
		tracker.pointingDevice = pointingDevice;
